    ...
    const char* ssid = "pms_network";                                     // key in your wifi-router name (can use handphone to check your wifi full name)
    const char* password =  "11221453";                                           // key in your wifi-router password
          ...
          if (httpCode == HTTP_CODE_OK || httpCode == HTTP_CODE_MOVED_PERMANENTLY) 
            {
              ...
              // To find second value (total deaths) from return value again : 75,779 2,13016,917           
